import {SAVE_FUEL_SAVINGS, CALCULATE_FUEL_SAVINGS, CALCULATE} from '../constants/actionTypes';
...
export default function homeReducer(state = initialState.home, action) {
  ...
  switch (action.type) {
    case CALCULATE:
      ...
      console.log('reducer',action.sum);
      return objectAssign({}, state, {sum: action.sum});
    default:
      return state;
  }
}
